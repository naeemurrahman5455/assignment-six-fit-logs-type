...
//   return (
//     <header className=" container mx-auto sticky top-0 z-50 w-full border-b border-[#9CA3AF]/20 bg-[#0C0D10]">
...
//               <span className="text-sm font-black text-[#0C0D10]">F</span>
//             </div>
...
//                   active ? "text-[#C2F800]" : "text-[#9CA3AF] hover:text-white"
//                 }`}
//               >
//                 {item.label}
...
//           {/* Divider */}
//           <div className="my-3 h-px bg-[#9CA3AF]/30" aria-hidden="true" />
